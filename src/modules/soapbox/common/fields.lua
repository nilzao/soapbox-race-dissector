...
f_sb_srv_pkt_type = ProtoField.bytes("soapbox.srvtype", "Srv Pkt Type")
...
f_sb_unknown = ProtoField.bytes("soapbox.unknown", "Uknown")
...
f_persona_name = ProtoField.string("soapbox.personaid", "Persona Name", base.ASCII)
...
f_sb_crypto_ticket = ProtoField.bytes("soapbox.cryptotkt", "Crypto Ticket")
f_sb_ticket_iv = ProtoField.bytes("soapbox.ticketiv", "Ticket IV")
f_sb_chan_info = ProtoField.string("soapbox.channel", "Channel", base.ASCII)
